...
\title{ \huge Superconducting Devices\\ \vspace{0.3cm}
\large From Strong Magnetic Fields to Ultra-Sensitive Sensing
\small \\  \vspace{0.3cm} Superconductivity and Quantum Materials}

\author{Filippo Vicidomini\\ Ca' Foscari University of Venice }
...
\tableofcontents
% table of points and speech for each slide
...
\section{Superconducting Devices: From Strong Magnetic Fields to Ultra-Sensitive Sensing}
...
\subsection{One Physics, Two Device Families}
...
\subsection{What is a Superconductor?}
...
So the key point to remember here is this: superconductivity combines zero resistance, magnetic-field expulsion, and quantized magnetic behavior in the same physical state. The next question is why matter reorganizes itself in this way at the quantum level.
}

%------------------------------------------------

\subsubsection{What Changes at the Quantum Level?}

\points{
\begin{itemize}
\item In a normal metal, electrons scatter independently
\item Below \(T_c\), electrons form Cooper pairs
\item Pairs condense into one coherent quantum state
\item An energy gap \(\Delta\) protects the condensate
\end{itemize}
}

\speech{
This is the microscopic transition behind superconductivity.

In an ordinary metal, electrons behave mostly as independent particles. As they move through the crystal, they scatter off lattice vibrations, defects, and other excitations, and this scattering is what produces electrical resistance.

Below the critical temperature, the situation changes. An effective attractive interaction, usually mediated by lattice vibrations, allows electrons near the Fermi surface to form bound pairs, called Cooper pairs. Each pair contains two electrons with opposite momentum and opposite spin.

These pairs do not act like isolated molecules. A macroscopic number of them condenses into the same collective quantum state, so the material develops long-range coherence.

At the same time, an energy gap opens in the excitation spectrum. This means that small perturbations are no longer enough to break pairs or scatter the condensate in the usual way.

So the matter is reorganized at the quantum level: instead of many independent electrons, we have a coherent condensate of paired electrons. This microscopic change is what later gives us zero resistance, flux quantization, and the Josephson effect.
}

%------------------------------------------------

\subsection{Macroscopic Phase and Josephson Effect}
...
\speech{
Once this coherent condensate exists, the superconducting state can be described by a macroscopic wavefunction, written as $\psi = |\psi| e^{i\theta}$. The important quantity here is the phase $\theta$.
...
\subsection{From Josephson Junction to SQUID}
...
\subsection{Magnetoencephalography (MEG)}
...
\subsubsection{MEG System and Advantages}
...
\subsection{Buried-Metal Detection}
...
\subsubsection{Buried-Metal Detection: Why SQUIDs?}
...
\subsubsection{Water Treatment: Role of Superconductivity}
